...
def build_agents(llm: LLM | dict[str, LLM]):
    info_hunter = Agent(
        ...
        backstory=(
            ...
            "และระบุแหล่งอ้างอิงเมื่อเป็นไปได้ ถ้า LLM/tool รองรับการค้นเว็บ คุณต้องค้นคว้าเชิงรุก "
            "แต่ถ้าไม่รองรับ ให้ระบุคำค้นหรือแหล่งข้อมูลที่ควรตรวจต่ออย่างชัดเจน"
        ),
    ...
    fact_checker = Agent(
        ...
        backstory=(
            ...
            "และเสนอวิธีเพิ่มสกิลหรือขั้นตอนค้นคว้าต่อเมื่อข้อมูลยังไม่พอ"
        ),
