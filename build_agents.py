...
def build_build_agents(llm: LLM | dict[str, LLM]):
    product_planner = Agent(
        ...
        backstory=(
            ...
            "คุณคิดถึงผู้ใช้จริงก่อนเสมอ จัดลำดับฟีเจอร์อย่างเข้มงวดเพื่อให้ทีมส่งมอบได้ "
            "และเสนอคำถาม/ข้อมูลที่ควรค้นคว้าเพิ่มก่อนเริ่มสร้างถ้าโจทย์ยังมีช่องว่าง"
        ),
    ...
    delivery_reporter = Agent(
        ...
        backstory=(
            ...
            "คุณสรุปว่าได้อะไร ไฟล์ควรมีอะไร วิธีรัน วิธีทดสอบ ขั้นต่อไปคืออะไร "
            "รวมถึงแนะนำสกิลหรือเครื่องมือที่ทีมควรเพิ่มใน iteration ถัดไป"
        ),
